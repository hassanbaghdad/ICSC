...
<script>
    export default {
        ...
        data(){
            return{
                tenders:[
                    {tender_title:'استيرادية',tender_title_en:'Import Tender'},
                    {tender_title:'المحلية',tender_title_en:'Local Tender'},
                    {tender_title:' المواد الاولية',tender_title_en:'Raw materials'},
                ]
            }
        }
    }
